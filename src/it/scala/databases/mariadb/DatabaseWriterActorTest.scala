...
import com.wegtam.scalatest.tags.{ DbTest, DbTestMariaDb }
...
class DatabaseWriterActorTest extends ActorSpec with BeforeAndAfterEach {
  ...
  val databaseHost = testConfig.getString("mariadb.host")
  val databasePort = testConfig.getInt("mariadb.port")
  val databaseName = testConfig.getString("mariadb.target-db.name")
  val databaseUser = testConfig.getString("mariadb.target-db.user")
  val databasePass = testConfig.getString("mariadb.target-db.pass")
  ...
  override protected def beforeEach(): Unit = {
    ...
    val connection = java.sql.DriverManager
      .getConnection(s"jdbc:mariadb://$databaseHost:$databasePort/", databaseUser, databasePass)
  ...
  describe("DatabaseWriterActor") {
    describe("using mariadb") {
      describe("initialise") {
        it("should create the tables", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
          )
        ...
        it("should not create tables that are already existing", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
        ...
        it("should create primary keys if defined", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
        ...
        it("should create auto-increment columns if defined", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
        ...
        it("should create the unique columns if defined", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
        ...
        it("should create primary keys, foreign keys and auto increments", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
      ...
      describe("writing data") {
        describe("using a single sequence") {
          describe("when given data for a single row") {
            it("should write a sequence row", DbTest, DbTestMariaDb) {
              val connection = java.sql.DriverManager.getConnection(
                s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
                databaseUser,
                databasePass
          ...
          describe("when given data for multiple rows") {
            describe("without primary key") {
              it("should write all possible sequence rows", DbTest, DbTestMariaDb) {
                val connection = java.sql.DriverManager.getConnection(
                  s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
                  databaseUser,
                  databasePass
            ...
            describe("with primary key") {
              it("should write new and update existing rows", DbTest, DbTestMariaDb) {
                val connection = java.sql.DriverManager.getConnection(
                  s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
                  databaseUser,
                  databasePass
        ...
        describe("when retrieving ordered column data") {
          it("should write the columns in correct order", DbTest, DbTestMariaDb) {
            val connection = java.sql.DriverManager.getConnection(
              s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
              databaseUser,
              databasePass
      ...
      describe("using auto increment columns") {
        it("should collect the written auto increment values", DbTest, DbTestMariaDb) {
          val connection = java.sql.DriverManager.getConnection(
            s"jdbc:mariadb://$databaseHost:$databasePort/$databaseName",
            databaseUser,
            databasePass
